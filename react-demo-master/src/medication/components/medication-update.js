...
class MedicationUpdate extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            formControls: {
                id: {
                    value: '',
                    placeholder: 'Search by medicament ID',
                    valid: false,
                    touched: false,
                    validationRules: {
                        isNumber:true,
    ...
    updatePatient(medicament) {
        return API_MEDICATION.updateMedication(medicament.id,medicament,(result, status, error) => {
            if (result !== null && (status === 200 || status === 201)) {
                console.log("Successfully updated medicament with id: " + result);
                this.reloadHandler();
            } else {
                this.setState(({
                    errorStatus: status,
    ...
    render() {
        return (
            <div>
                ...
                <FormGroup id='dosage'>
                    <Label for='dosageField'> Set new dosage </Label>
                ...
                <FormGroup id='sideEffects'>
                    <Label for='sideEffectsField'> Set new sideEffects </Label>
