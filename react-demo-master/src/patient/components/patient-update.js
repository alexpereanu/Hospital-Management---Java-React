...
import * as API_DOCTOR from "../api/patient-api";
...
class PatientUpdate extends React.Component {
    ...
    updatePatient(patient) {
        return API_DOCTOR.updatePatient(patient.name,patient,(result, status, error) => {
    ...
    render() {
        return (
            <div>
                ...
                <FormGroup id='gender'>
                    <Label for='genderField'> Set new gender: </Label>
                ...
                <FormGroup id='address'>
                    <Label for='addressField'> Set new address: </Label>
